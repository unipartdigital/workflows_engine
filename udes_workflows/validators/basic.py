...
_is_true = func_factory(defaults.is_true, Validator, _make_identifier)
_is_false = func_factory(defaults.is_false, Validator, _make_identifier)
...
def is_true(value_key=None, **kwargs):
    kwargs["value_key"] = value_key
    return _is_true(**kwargs)


def is_false(value_key=None, **kwargs):
    kwargs["value_key"] = value_key
    return _is_false(**kwargs)
